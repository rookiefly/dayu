...
<head>
    ...
    <link href="${base}/resources/assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet"
          type="text/css"/>
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo" style="">
            <span id="main-title" class="navbar-brand start" href="#" style="font-size: 50px;">
                <span style="font-size: 22px;font-weight: bold;color: #86B4DC;">Dubbo服务治理</span>
            </span>
...
<div class="page-container ">
    ...
    <div class="page-content-wrapper ">
        <iframe width="100%" class="page-content" style="min-height: 196px;" frameborder="no" scrolling="auto"
                border="0" src="${base}/monitor/dash/index" id="mainIframe" name="mainIframe"></iframe>
    </div>
    <!-- END CONTENT -->
</div>
<!-- END CONTAINER -->
...
<script src="${base}/resources/assets/global/plugins/bootstrap-modal/js/bootstrap-modalmanager.js"
        type="text/javascript"></script>
<script src="${base}/resources/assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js"
        type="text/javascript"></script>
