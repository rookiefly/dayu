            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-helper">仅展示前30条记录</span>
                    </div>
            ...
            <div class="portlet light tasks-widget">
                ...
                <div class="portlet-body" id="app_main_body">
                    <ul class="pager">
                        ...
                        <li class="center">
                            当前页数
                            <input type="text" id="now_page_size" value="1" class="form-control input-inline"
                                   style="width: 5%;">/
                            总页数：
...
<#include "//dashboard/dashboard_template.ftl" />
<script>
